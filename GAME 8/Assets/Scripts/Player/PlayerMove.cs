...
public class PlayerMove : MonoBehaviour
{
    ...
    {
        rb2d.velocity = new Vector2(Input.GetAxis("Horizontal") * speed* gameObject.transform.localScale.x, rb2d.velocity.y);
    ...
    private void JumpController()
    {
        if (DetectGround.checkGround == true)
        {
            ...
            if (Input.GetKeyDown("space"))
            {
                ...
                rb2d.velocity = new Vector2(rb2d.velocity.x, jumping* gameObject.transform.localScale.y);
            }
        }
